<?php /* Smarty version Smarty-3.1.6, created on 2018-02-06 20:28:13
         compiled from "./APP/Api/View\index\index.html" */ ?>
<?php /*%%SmartyHeaderCode:266635a799f5dc7f486-17882388%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3dd867a498551e2a1cbf29c11a6dfa30d863bf68' => 
    array (
      0 => './APP/Api/View\\index\\index.html',
      1 => 1515505094,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '266635a799f5dc7f486-17882388',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a799f5e1195f',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a799f5e1195f')) {function content_5a799f5e1195f($_smarty_tpl) {?>
<!DOCTYPE html>
<html>
<head>
...
<div id="main">
    ...
    <form name=alipayment action="index.php?m=api&c=index&a=pagepay" method="post" target="_blank">
...
<script language="javascript">
    ...
    function GetDateNow() {
        ...
        document.getElementById("WIDout_trade_no").value =  <?php echo $_smarty_tpl->tpl_vars['dindan']->value['ornum'];?>
;
        document.getElementById("WIDsubject").value = "壹点壹客商品订单---支付宝";
        document.getElementById("WIDtotal_amount").value = "<?php echo $_smarty_tpl->tpl_vars['dindan']->value['amount'];?>
";
    }
    GetDateNow();
</script>
