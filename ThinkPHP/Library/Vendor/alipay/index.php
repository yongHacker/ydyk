...
<div id="main">
    <div id="tabhead" class="tab-head">
        ...
        <form name=alipayment action="http://www.jiang.com/index.php?m=Api&c=Index&a=pagepay" method="post" target="_blank">
...
<script language="javascript">
	...
	function GetDateNow() {
		...
		document.getElementById("WIDsubject").value = "我的第一笔订单";
